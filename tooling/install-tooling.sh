...
# ktlint
echo "Downloading & setting up ktlint binary...(Machine Password may be asked once if ktlint binary is not configured)"
...
# detekt
echo "Downloading & setting up detekt binary...(Machine Password may be asked once if detekt binary is not configured)"
